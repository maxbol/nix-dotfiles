...
in {
  options = {
    maxdots.chroma.gtk = {
      ...
      gtk2.extraConfig = mkOption {
        ...
        default =
          options.maxdots.chroma.gtk.gtk3.extraConfig.default
          // {
      ...
      gtk3.extraConfig = mkOption {
        type = options.maxdots.chroma.gtk.gtk2.extraConfig.type;
        # TODO: move the default settings elsewhere
        default = {
      ...
      gtk4 = {
        ...
        extraConfig =
          options.maxdots.chroma.gtk.gtk3.extraConfig
          // {
  ...
  imports = [
    (mkIf (cfg.enable && cfg.gtk.enable) {
      ...
      home.packages = (concatLists (mapAttrsToList (name: opts: with opts.gtk; concatMap optionalPackage [theme documentFont]) cfg.themes)) ++ [pkgs.gnome-themes-extra];
